...
> **Targets StoatFlow 1.0.0-beta.5 (Kafka Streams 4.3 API surface).** Pre-GA — pin the matching
...
// build.gradle.kts
dependencies {
  implementation("io.stoatflow:stoatflow-runtime:1.0.0-beta.5")   // batteries-included (pulls -core)
  // implementation("io.stoatflow:stoatflow-core:1.0.0-beta.5")   // DSL/engine only
  // testImplementation("io.stoatflow:stoatflow-test-utils:1.0.0-beta.5")
}
```
