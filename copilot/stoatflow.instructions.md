...
> **Targets StoatFlow 1.0.0-beta.4 (Kafka Streams 4.3 API surface).** Pre-GA — pin the matching
...
// build.gradle.kts
dependencies {
  implementation("io.stoatflow:stoatflow-runtime:1.0.0-beta.4")   // batteries-included (pulls -core)
  // implementation("io.stoatflow:stoatflow-core:1.0.0-beta.4")   // DSL/engine only
  // testImplementation("io.stoatflow:stoatflow-test-utils:1.0.0-beta.4")
}
```
...
- Machine-readable docs (fetch when you need a detail this file omits):
  <https://stoatflow.io/llms.txt> (index) · <https://stoatflow.io/llms-full.txt> (full bundle) ·
  any indexed page as raw markdown at `/raw/<path>.md`
